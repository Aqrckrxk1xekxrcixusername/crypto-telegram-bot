# ✅ فایل دوم: bot.py (ربات تلگرام + تحلیل بازار)
import requests
import time
import html
import datetime
...
MARKETAUX_API_KEY = 'کلید_API_Marketaux'
...
scheduler.add_job(run_news_bot, 'interval', minutes=10)
scheduler.start()

print("✅ ربات خبری و تحلیلی فعال شد ✅")
